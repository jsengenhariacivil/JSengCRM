...
interface FinancialAnalysisProps {
    initialTab?: 'dre' | 'cashflow' | 'payables';
}

const FinancialAnalysis: React.FC<FinancialAnalysisProps> = ({ initialTab = 'dre' }) => {
    const { financials } = useData();
    const [activeTab, setActiveTab] = useState<'dre' | 'cashflow' | 'payables'>(initialTab);

    // Sincroniza aba se mudar via rota
    React.useEffect(() => {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="flex border-b border-slate-100 overflow-x-auto">
                    <button
                        ...
                        className={`px-6 py-4 font-medium text-sm flex items-center gap-2 transition-colors whitespace-nowrap ${activeTab === 'dre'
                    ...
                    <button
                        ...
                        className={`px-6 py-4 font-medium text-sm flex items-center gap-2 transition-colors whitespace-nowrap ${activeTab === 'cashflow'
                            ? 'text-[#c79229] border-b-2 border-[#c79229] font-bold bg-orange-50/30'
                            : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-6 py-4 font-medium text-sm flex items-center gap-2 transition-colors whitespace-nowrap ${activeTab === 'payables'
                            ? 'text-[#c79229] border-b-2 border-[#c79229] font-bold bg-orange-50/30'
                            : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'
                            }`}
                    >
